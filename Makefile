...
dev:
	...
	@echo "📱 Frontend will be available at http://localhost:3200"
	@echo "🔧 Backend will be available at http://localhost:8200"
	@echo "📚 API Documentation at http://localhost:8200/docs"
	@echo ""
